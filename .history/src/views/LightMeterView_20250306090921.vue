  ...
  for (let y = 0; y < canvas.height; y++) {
    for (let x = 0; x < canvas.width; x++) {
      ...
      if (distanceFromCenter <= radius) {
        ...
        const pixelBrightness = data[pixelIndex] * 0.2126 + data[pixelIndex + 1] * 0.7152 + data[pixelIndex + 2] * 0.0722
    ...
    <div class="main-content">
      ...
      <div class="exposure-info">
        ...
        <div class="exposure-params">
          <div class="param" :class="{ highlight: typeFlag === 'aperture' }" @click="showApertureSelector = !showApertureSelector; showShutterSelector = false; showIsoSelector = false; showEvSelector = false;">
            <span class="label">光圈:</span>
            <span class="value">f/{{ aperture.toFixed(1) }}</span>
          </div>
          <div class="param" :class="{ highlight: typeFlag === 'shutter' }" @click="showShutterSelector = !showShutterSelector; showApertureSelector = false; showIsoSelector = false; showEvSelector = false;">
          ...
          <div class="param" @click="showIsoSelector = !showIsoSelector; showApertureSelector = false; showShutterSelector = false; showEvSelector = false;">
            <span class="label">ISO:</span>
            <span class="value">{{ iso }}</span>
          </div>
          <div class="param" @click="showEvSelector = !showEvSelector; showApertureSelector = false; showShutterSelector = false; showIsoSelector = false;">
      ...
      <div v-if="showApertureSelector" class="popup-selector">
        ...
        <div class="aperture-selector">
          <div
            ...
            @click="aperture = value; showApertureSelector = false"
          >
            f/{{ value.toFixed(1) }}
          </div>
        </div>
      ...
      <div v-if="showShutterSelector" class="popup-selector">
        ...
        <div class="shutter-selector">
          <div
            ...
            @click="shutterSpeed = speed; showShutterSelector = false"
          >
      ...
      <div v-if="showIsoSelector" class="popup-selector">
        ...
        <div class="iso-selector">
          <div
            ...
            @click="iso = value; showIsoSelector = false"
          >
            {{ value }}
          </div>
        </div>
